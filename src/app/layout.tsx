...
export default function RootLayout({
  ...
  return (
    <html lang='en'>
      <body className={`${inter.className} min-h-screen w-[100vw] max-w-[100vw] overflow-x-hidden`}>
        <main className={'absolute h-[auto] w-full bg-[linear-gradient(to_right,#2b385f1a_1px,transparent_1px),linear-gradient(to_bottom,#2b385f1a_1px,transparent_1px)] bg-[size:42px_42px] bg-[#F9FAFC] dark:bg-[#060719]'}>
