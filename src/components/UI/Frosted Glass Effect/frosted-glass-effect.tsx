...
import { useGetPointerMovement } from '@/utils/Hooks/useGetPointerMovement';

import { Devtools, useDevtoolsState } from '../devtools/devtools';

const FrostedGlassEffect = () => {
  const pointerProps = useGetPointerMovement(true);
  const devtoolsState = useDevtoolsState();
// video: https://www.frontend.fyi/v/frosted-glass-effect
  return (
