'use client';
import classes from './MagneticButton.module.scss';
import Gsap from "@/components/UI/Buttons/Magnetic Button/gsap";
import Framer from "@/components/UI/Buttons/Magnetic Button/Framer";
