...
function NavbarScroll({ isScrolling }: { isScrolling: boolean}) {
  return (
    <motion.nav initial={"initial"} animate={"animate"} exit={"exit"} key={1} variants={NavAnimation} className="fixed z-10 flex justify-between px-4 py-2 rounded-full ts-bg left-1/2 top-10">
